...
C = 0.001	Precision: 0.951, Recall: 1.000, F1: 0.975
<br>(需要图片)
## 4.2	SVM
...
## 4.3	Decision Tree
max_depth = 14	Precision: 0.957, Recall: 0.997, F1: 0.977
...
<div align=center>|Model Type| PRE* | REC | F1-score |
| ------|------- | ------|------- |
...
| PCA_Tree | 0.974* | 0.875 | 0.922 |</div>
